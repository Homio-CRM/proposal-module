...
export const FormDataSchema = z.object({
  ...
  maritalStatus: z.string().min(1, 'Estado civíl inválido'),
  birthDate: z.string().min(7, 'Data de Nascimento é obrigatório'),
  address: z.string().min(7, 'Endereço é obrigatório'),
  zipCode: z.string().min(8, 'Cep é Obrigatório').max(9, 'Cep deve ser formatado como: 00000-000').regex(new RegExp(/^\d{5}-\d{3}$/), 'Cep inválido'),
